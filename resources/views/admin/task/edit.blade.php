            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\TaskController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" name="name" rows="20">{{ $task->name }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            @foreach($tags as $tag)
                                @if (in_array($tag->id, $taskTags))
                                    <input type="checkbox" id="tag{{ $loop->iteration }}" name="task_tags[]" value="{{ $tag->id }}"checked />
                                @else
